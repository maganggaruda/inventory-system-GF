...
if (!empty($keyword)) {
    ...
    $where_clauses[] = "(k.nama_bagian LIKE '%$kw%' OR m.kode_mesin LIKE '%$kw%' OR rm.teknisi LIKE '%$kw%' OR rm.tindakan LIKE '%$kw%')";
}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">
                                            ...
                                            <?php if (!empty($m['kode_mesin'])): ?>
                                                (<span class="text-primary font-monospace"><?= htmlspecialchars($m['kode_mesin']) ?></span>)
                                            <?php endif; ?>
                                        </small>
                                    </td>
                                    <td>

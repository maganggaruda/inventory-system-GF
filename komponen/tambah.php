...
if (isset($_POST['simpan'])) {
    ...
    /* =========================================================
       AMBIL NAMA SUB MESIN
    ========================================================= */
    if ($id_sub_mesin) {

        $stmt_s = mysqli_prepare(
            $conn,
            "SELECT nama_sub_mesin
             FROM sub_mesin
             WHERE id = ?"
        );
    ...
    /* =========================================================
       DATA KOMPONEN
       KATEGORI SUDAH DIHAPUS DARI FORM
       DAN DISET KOSONG
    ========================================================= */
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="dashboard-subtitle m-0 small text-muted">
                    Lengkapi formulir di bawah ini untuk mendaftarkan komponen/part baru
                </p>
    ...
    <div class="content-card mb-3">
        ...
        <div class="card-body-custom p-3">
            ...
            <?php if (!empty($error)) : ?>
                ...
                <div class="alert alert-danger border-0 d-flex align-items-center py-2 px-3 mb-3"
                     role="alert">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <input
                            ...
                            required
                            value="<?= htmlspecialchars($_POST['nama_bagian'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-text text-muted small">
                            Format disarankan: JPG, PNG, WEBP (Maksimal 2MB).
                        </div>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['daya'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['io_address'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['input_voltage'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['frekuensi_input'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['arus_input'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['output'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['frekuensi_output'] ?? '') ?>"
                        >
                    ...
                    <div class="col-md-3">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($_POST['ip_rating'] ?? '') ?>"
                        >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        >
                            ...
                            <option value="Baik"
                                <?= (($_POST['kondisi'] ?? '') === 'Baik') ? 'selected' : '' ?>>
                                Baik
                            </option>

                            <option value="Perlu Pemeriksaan"
                                <?= (($_POST['kondisi'] ?? '') === 'Perlu Pemeriksaan') ? 'selected' : '' ?>>
                                Perlu Pemeriksaan
                            </option>

                            <option value="Dalam Perbaikan"
                                <?= (($_POST['kondisi'] ?? '') === 'Dalam Perbaikan') ? 'selected' : '' ?>>
                                Dalam Perbaikan
                            </option>
...
/* =========================================================
   LOAD JENIS MESIN BERDASARKAN AREA
========================================================= */
...
/* =========================================================
   LOAD MESIN BERDASARKAN JENIS MESIN
========================================================= */

...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        $stmt = mysqli_prepare($conn, "INSERT INTO jenis_mesin (id_area, nama_jenis_mesin) VALUES (?, ?)");
        mysqli_stmt_bind_param($stmt, "is", $id_area, $nama_jenis_mesin);
...
<div class="container-fluid p-0">
  ...
  <div class="dashboard-header mb-3 py-3 px-4">
    <div class="d-flex align-items-center gap-3">
      ...
      <div>
        <h3 class="dashboard-title m-0 fs-4 fw-bold">Tambah Jenis Mesin Baru</h3>
        <p class="dashboard-subtitle m-0 small text-muted">Isi formulir berikut untuk mendaftarkan kategori atau jenis mesin baru</p>
      </div>
    </div>
  </div>
  ...
  <div class="content-card mb-3">
    <div class="card-header-custom py-2 px-3">
      <h6 class="card-title-custom m-0 fw-bold">
        <i class="bi bi-plus-circle me-2"></i>Form Tambah Jenis Mesin
      </h6>
    </div>
      ...
      <form method="POST">
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="nama_jenis_mesin" class="form-control form-control-sm" placeholder="Contoh: Conveyor, Mixer, Filling Machine" value="<?= isset($_POST['nama_jenis_mesin']) ? htmlspecialchars($_POST['nama_jenis_mesin']) : '' ?>" required>
